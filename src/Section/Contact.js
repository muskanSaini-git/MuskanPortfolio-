...
import { isValidEmail } from "../checkemail"; // Adjust path as per your project structure
...
function ContactForm() {
  ...
  return (
    <section id="education" className="bg-gradient-to-r from-purple-600 via-blue-500 to-pink-600 text-white py-16">
      ...
      <div className="flex justify-center px-4 sm:px-6 lg:px-12">
        <div className="max-w-full sm:max-w-md md:max-w-2xl text-white rounded-lg border border-[#464c6a] p-3 lg:p-6">
